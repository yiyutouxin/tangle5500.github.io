...
video0 = VideoFileClip("test0.mp4").cutout(0, 5)   # 00:00:05-00:00:10 保留
video1 = VideoFileClip("test0.mp4").subclip(5, 10) # 00:00:05-00:00:05 剪掉
print(video0.duration)                     # 10.05 # 视频长度
...
```
subclip(5,10)                    # 00:00:05-00:00:10 保留
