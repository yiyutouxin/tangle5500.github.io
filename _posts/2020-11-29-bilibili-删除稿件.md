    ...
    for i in range (100000):
        try:
            ...
            if wait_if(".option-text"):
                ele = driver.find_element_by_class_name('option-text').click()
            if wait_if(".geetest_radar_tip"):
                ele = driver.find_element_by_class_name('geetest_radar_tip').click()
            if wait_if(".geetest_slider_button"):
                ele = driver.find_element_by_class_name('geetest_slider_button').click() # 滑块
            checkVeriImage(driver)
        except:
            driver.refresh()
