...
driver.get('https://member.bilibili.com/platform/upload-manager/article?order=click&page=5500')
print(driver.title)
...
class DragUtil():
    ...
    def simulateDragX(self, source, targetOffsetX):
        ...
        if dragCount == 2:
            ...
            sumOffsetx = random.randint(-30, 30)
...
def task():
    for i in range (100000):
        try:
            for i in range(50):
                if isElementExist(driver, '.more-btn'):
